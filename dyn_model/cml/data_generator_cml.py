...
parser.add_argument('--nodes', type=int, default=5, help='Number of nodes, default=10')
parser.add_argument('--samples', type=int, default=1000, help='Number of samples in simulation, default=7000')
parser.add_argument('--prediction-steps', type=int, default=20, help='prediction steps, default=10')
...
parser.add_argument('--data-dir', type=str, default='./', help='data name to save')
args = parser.parse_args()

save_name_origin = args.data_dir+'data_lambd3.5_coupl0.2_node'+str(args.nodes)+'_origin.pickle'
save_name_cut = args.data_dir+'data_lambd3.5_coupl0.2_node'+str(args.nodes)+'_cut.pickle'
save_name_adj = args.data_dir+'data_lambd3.5_coupl0.2_node'+str(args.nodes)+'_adj.pickle'
...
if __name__ == '__main__':
    ...
    print('original data shape\n(samples,nodes,evolving steps,dims):\n', simulates.shape)
    with open(save_name_origin,'wb') as f:
        pickle.dump(data,f)

    print('Object Matrix shape:\n',simulator.obj_matrix.shape)
    with open(save_name_adj,'wb') as f:
        pickle.dump(simulator.obj_matrix,f)
    ...
    print('dimensions after cutting\n(samples * cut, nodes, evolving step / cut, dims):\n', features.shape)
    ...
    with open(save_name_cut, 'wb') as f:
